...
public class DeviceServiceTest {
    ...
    public void getDeviceByUserById() throws Exception {
        ...
        assertThat(device.getSystemOS().getName()).isEqualTo("android");
        assertThat(device.getSystemOS().getVersion()).isEqualTo("6.0");
        assertThat(device.getModel()).isEqualTo("Motorola Moto X (2nd Gen)");
        assertThat(device.getHome().getGeoLocalization().getPosition()[0]).isEqualTo(Double.parseDouble("-46.5933971"));
        assertThat(device.getHome().getGeoLocalization().getPosition()[1]).isEqualTo(Double.parseDouble("-23.5169625"));
        assertThat(device.getWork().getGeoLocalization().getPosition()[0]).isEqualTo(Double.parseDouble("-46.6576926"));
        assertThat(device.getWork().getGeoLocalization().getPosition()[1]).isEqualTo(Double.parseDouble("-23.5597101"));
        ...
        assertThat(device.getPlaces().get(0).getVenue().getGeoLocalization().getPosition()[0]).isEqualTo(Double.parseDouble("-46.703318492148675"));
        assertThat(device.getPlaces().get(0).getVenue().getGeoLocalization().getPosition()[1]).isEqualTo(Double.parseDouble("-23.55298042202491"));
